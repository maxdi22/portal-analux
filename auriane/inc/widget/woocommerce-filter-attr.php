...
class Jws_Widget_Attributes_Filter extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.', 'auriane' );
		$this->widget_id          = 'jws_attributes_filter';
		$this->widget_name        = esc_html__( 'Jws Attributes Filter', 'auriane' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			'title'      => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Filter by', 'auriane' ),
				'label' => esc_html__( 'Title', 'auriane' )
			),
			'attribute'  => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'auriane' ),
				'options' => $attribute_array
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'auriane' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'auriane' ),
					'or'  => esc_html__( 'OR', 'auriane' )
				)
			),
		);
	}
	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type, $show_color , $show_image ) {
		...
		foreach ( $terms as $term ) {
            ...
            $css_class .= $show_image ? 'show-color ' : '';
            ...
            if ( $show_image ) {
				...
				printf(
					'<span class="swatch swatch-color swatch-images" style="background:url(%s);" title="%s"></span>',
