  ...
  jwsThemeWooModule = (function () {
    return {
          ...
          var checkExist = setInterval(function () {
            if ($("body > .woocommerce-error").length) {
              ...
              var loc = $("body > .woocommerce-error")
                ...
                .append('<span class="note-close jws-icon-cross"></span>')
        ...
        $(".jws-waitlist-form").on("submit", function (e) {
          ...
          $.ajax({
            ...
            .success(function (response) {
              $(".jws-waitlist-register").append(
                '<div class="note-output">' + response.note + "</div>"
              );
      ...
      jws_woocommerce_checkout_medern: function () {
        ...
        $("body").on("jws_update_custommer_info", function () {
          ...
          if ($("#jws-billing-info").length) {
            ...
            $("#jws-billing-info .customer-info-email .info-right").html(
              _email
            );
          }
        });
        ...
        $("body").on("click", "#apply_coupon_clone", function () {
          if (
            $('input[name="coupon_code_clone"]').length &&
            $('form.checkout_coupon input[name="coupon_code"]').length
          ) {
            $(".woocommerce-error, .woocommerce-message").hide();
        ...
        $("body").on(
          ...
          function () {
            if (
              $(".page_checkout_modern").length &&
              !$(".woocommerce-checkout-review-order").hasClass("processing")
            ) {
              $(".woocommerce-checkout-review-order").addClass("processing");
            }
          }
        ...
        $("body").on(
          "click",
          "#next-step-shipping .jws-next-step",
          function () {
      ...
      jws_validate_form_checkout: function () {
        ...
        var _diffirent = _form
          .find('[name="ship_to_different_address"]')
          .is(":checked")
          ? true
          : false;

        var _wrap = !_diffirent
          ? _form.find(".woocommerce-billing-fields")
          : _form.find("#customer_details");
      ...
      jws_update_shipping_methods: function () {
        if (
          $(".jws-shipping-wrap").length &&
          $(".order-shipping-modern").length
        ) {
          var _shipping = "";
          ...
          $(".jws-shipping-wrap").each(function () {
            ...
            if (_this.find("#shipping_method").length) {
               ...
               */
              _shipping +=
                '<ul id="shipping_method_clone" class="woocommerce-shipping-methods-clone">';
          ...
          if (_available) {
            ...
            $("#jws-billing-info .customer-info-method .info-right").html(
              _avai_html
            );
          }
        }
            ...
            $.get(
              ...
              function (res) {
                $("#answer-question-list .jws-pagination-number").html(
                  $(res)
                    .find("#answer-question-list .jws-pagination-number")
                    .html()
                );
                $("#answer-question-list > ul").html(
                  $(res).find("#answer-question-list > ul").html()
                );
              },
              "html"
            );
      ...
      swatchesVariations: function () {
        ...
        var scrollToTop = function () {
          if (
            !$("body").hasClass("aurianeduct-design-sticky") ||
      ...
      productImagesGallery: function () {
        ...
        if (
          $slider_wap.hasClass("layout_gid_two_coloms") ||
          $slider_wap.hasClass("layout_vertical_metro") ||
          $slider_wap.hasClass("layout_vertical")
        ) {
          return false;
        }
        if (
      ...
      filterAjax: function () {
        ...
        if ($(window).innerWidth() < 991) {
          $(document.body)
            .find(".filter-shop-nav")
            .on("click", ".widget-title", function (e) {
              $(".filter-shop-nav")
                .find(".widget-title")
                .not(this)
                .next()
        ...
        $(document.body).on(
          ...
          function (e) {
            ...
            $(document.body).trigger("auriane_catelog_filter_ajax", [
              url,
              $(this),
            ]);
          }
            ...
            $.get(
              ...
              function (res) {
                ...
                $(document.body).trigger(
                  "auriane_ajax_filter_request_success",
                  [res, url]
                );
              },
              "html"
        ...
        $(document.body).on(
          "auriane_ajax_filter_before_send_request",
          function () {
            if (
