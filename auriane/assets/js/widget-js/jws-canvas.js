(function ($) {
  ...
  $(document)
    ...
    .on(
      "click.opentrigger  resize",
      ".jws-offcanvas-trigger.action",
      function () {
  ...
  $(document).on("jws_offcanvas_init", function (e, node_id) {
    ...
    $(document).on("keyup", function (e) {
      if (e.keyCode == 27) {
        $(".jws-offcanvas-parent-wrapper").each(function () {
          var $this = $(this);
          var canvas_id = $this
            .closest(".jws-offcanvas-parent-wrapper")
            .data("id");
    ...
    $(".jws-offcanvas-overlay")
      ...
      .on("click.overlaytrigger", function () {
        $(".jws-offcanvas-parent-wrapper").each(function () {
          var $this = $(this);
          var canvas_id = $this
            .closest(".jws-offcanvas-parent-wrapper")
        ...
        if ("undefined" != typeof custom && "" != custom) {
          ...
          if (custom_selectors.length > 0) {
            for (i = 0; i < custom_selectors.length; i++) {
              if (
                "undefined" != typeof custom_selectors[i] &&
                "" != custom_selectors[i]
              ) {
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/Offcanvas.default",
      WidgetOffCanvasHandler
    );
  });
  $(document).ready(function () {
