...
if ( class_exists( 'Custom_WC_Product_Cat_List_Walker', false ) ) {
	return;
}
...
class Custom_WC_Product_Cat_List_Walker extends WC_Product_Cat_List_Walker  {
	...
	public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		$output .= '"><a href="' . jws_shop_page_link(true,get_term_link( $cat_id, $this->tree_type )) . '">' . apply_filters( 'list_product_cats', $cat->name, $cat ) . '</a>';
